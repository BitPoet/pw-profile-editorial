...
function makeSocialLink($social) {
	$link = str_replace("{name}", $social->blog_headline, $social->blog_summary);
	return "<li><a href='$link' title='{$social->title}' class='icon fa-{$social->blog_icon}'><span class='label'>{$social->title}</span></a></li>\n";
}
